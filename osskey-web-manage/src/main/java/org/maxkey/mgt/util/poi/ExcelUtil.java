package org.maxkey.mgt.util.poi;
...
import org.maxkey.aspectj.annotation.Excel;
import org.maxkey.aspectj.annotation.Excels;
import org.maxkey.domain.result.ResponseResult;
import org.maxkey.mgt.exception.ImportException;
import org.maxkey.mgt.file.FileTypeUtils;
import org.maxkey.mgt.file.FileUploadUtils;
import org.maxkey.mgt.file.ImageUtils;
import org.maxkey.mgt.util.reflect.ReflectUtils;
...
public class ExcelUtil<T>
{
            ...
            for (int i = 1; i < rows; i++)
            {
                ...
                for (Map.Entry<Integer, Field> entry : fieldsMap.entrySet())
                {
                    ...
                    else if (Date.class == fieldType)
                    {
                        ...
                        {
                            val = DateUtils.parse((String)val);
                        }
     ...
     * @return 结果
     */
    public ResponseResult<String> importTemplateExcel(String sheetName)
    {
     ...
     * @return 结果
     */
    public ResponseResult<String> exportExcel()
    {
        ...
        try
        {
            ...
            wb.write(out);
            return ResponseResult.newInstance(filename);
        }
        catch (Exception e)
        {
            log.error("导出Excel异常{}", e.getMessage());
            throw new ImportException("导出Excel失败，请联系网站管理员！");
        }
        finally
        {
            if (wb != null)
    ...
    public String getAbsoluteFile(String filename)
    {
        ...
        String downloadPath = localPath +  WebConstants.RESOURCE_PREFIX;
