...
@RestController
@RequestMapping(value = {"/auth/manage/socialsignon"})
public class SocialManagerController {
    final static Logger _logger = LoggerFactory.getLogger(SocialManagerController.class);
    @Autowired
    ...
    public PageResult<SocialSignOnProvider> forwardUpdate() {
        ...
        if (applicationConfig.getLoginConfig().isSocialSignOn()) {
            ...
            return PageResult.newInstance(listBindSocialSignOnProvider);
        }
